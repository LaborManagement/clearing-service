# ============================================
# Dockerfile for clearing-service (Multi-stage build)
...
# Copy clearing-service pom.xml first for dependency caching
COPY pom.xml .

# Download dependencies (cached layer if pom.xml unchanged)
RUN mvn dependency:go-offline -B -q || true

# Copy clearing-service source code
COPY src ./src

# Build clearing-service (shared-lib is now available in local Maven repo)
...
LABEL service="clearing-service"
LABEL version="1.0"
